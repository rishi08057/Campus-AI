      ...
      <div className="space-y-8 h-full flex flex-col">
        <div>
          ...
          <p className="mt-2 text-lg text-slate-600">
            I can help you with symptom guidance, wellness resources, and health reminders.
          </p>
        </div>
        ...
        <div className="flex-1 rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-12 flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <p className="text-slate-500">
              The Health Agent is currently under development. Check back soon for wellness features!
            </p>
          </div>
        </div>
      </div>
