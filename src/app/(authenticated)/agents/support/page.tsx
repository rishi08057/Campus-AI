...
export default function SupportAgentPage() {
  ...
  useEffect(() => {
    ...
    const allSessions = getAllSessions("support");
  ...
  const handleDeleteSession = (
    ...
    if (window.confirm("Delete this chat?")) {
      ...
      setSessions(getAllSessions("support"));
  ...
  const quickActions = [
    {
      ...
      prompt: "What is the university's attendance policy and minimum requirement?",
    },
    {
      label: "Exam Information",
      prompt: "What are the rules and guidelines for semester-end examinations?",
    },
    {
      label: "Faculty Directory",
      prompt: "How can I contact my professors or view the faculty directory?",
    },
    {
      label: "Room Locations",
      prompt: "How do I locate classrooms and buildings on campus?",
    },
  ];
        ...
        <main className="flex-1 flex flex-col min-w-0">
          <section className="flex-1 overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur flex flex-col">
            <ChatBox
              ...
              agentType="support"
              title="Support Agent"
              subtitle="Ask about attendance, examinations, faculty, classrooms, and university support."
              quickActions={quickActions}
              emptySubtitle="Ask about attendance, examinations, faculty, classrooms, and university support."
            />
          </section>
        </main>
      </div>
